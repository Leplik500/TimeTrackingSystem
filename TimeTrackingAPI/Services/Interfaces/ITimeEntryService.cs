...
public interface ITimeEntryService
{
    ...
    Task<ApiResponse<List<TimeEntry>>> GetTimeEntriesByDateAsync(
            DateTime date);
    ...
    Task<ApiResponse<List<TimeEntry>>>
    ...
    Task<ApiResponse<TimeEntry>> CreateTimeEntryAsync(
            TimeEntry timeEntry);
    ...
    Task<ApiResponse<List<DailyHoursSummaryDto>>>
